        ...
        body: JSON.stringify({
          emails: formulario.tipo === 'Maquilas'
            ? ['a.garcilita@aionsuplementos.com', 'b.solano@aionsuplementos.com', 'r.contreras@aionsuplementos.com', 
              'j.leyva@aionsuplementos.com', 'c.alvarez@aionsuplementos.com', 't.alvarez@aionsuplementos.com', 
              'j.pérez@aionsuplementos.com', 'j.corona@aionsuplementos.com', 'p.gomez@aionsuplementos.com', 
              'o.rivera@aionsuplementos.com', 'r.barberena@aionsuplementos.com', 'k.bayardo@aionsuplementos.com', 
              'j.alvarado@aionsuplementos.com', 'f.cruz@aionsuplementos.com', 'r.castellanos@aionsuplementos.com', 
              'v.rivera@aionsuplementos.com', 'y.juarez@aionsuplementos.com']
            : ['a.garcilita@aionsuplementos.com', 'b.solano@aionsuplementos.com', 'r.contreras@aionsuplementos.com', 
              'j.leyva@aionsuplementos.com', 'c.alvarez@aionsuplementos.com', 't.alvarez@aionsuplementos.com', 
              'j.pérez@aionsuplementos.com', 'j.corona@aionsuplementos.com', 'p.gomez@aionsuplementos.com', 
              'o.rivera@aionsuplementos.com', 'k.bayardo@aionsuplementos.com', 'j.alvarado@aionsuplementos.com', 
              'f.cruz@aionsuplementos.com', 'r.castellanos@aionsuplementos.com', 'v.rivera@aionsuplementos.com', 
      ...
      const enviarNotificacion = fetch('/api/Reminder/EnvioEvento', {
        ...
        body: JSON.stringify({
          formData2: {
            ...
            descripcion: `<strong>${
              nombre + " " + apellidos
            }</strong> ha subido una nueva etiqueta de tipo: <strong>${formulario.tipo}</strong>.<br>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1">
              <div>
                ...
                {nowPdfPreview && (
                  <div className="mt-2">
                    <embed src={nowPdfPreview} type="application/pdf" width="100%" height="700px" />
                  </div>
                )}
              </div>
            </div>
      ...
      <Select
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="col-span-full space-y-2">
            ...
            placeholder="..." onChange={(e) => handleInputChange(e.target.value, e.target.name)} value={formulario?.description || ""} />
          </div>
          {modificacionesDiseñador.map((item, index) => (
              <div key={item} className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(value) => handleInputChange(value, `miSelectDiseñador${index + 1}`)}
                >
                  <SelectTrigger>
        ...
        <Button type="submit" className="w-full" disabled={!formularioCompleto()}>Guardar etiqueta</Button>
      </form>
    </div>
  );
}
