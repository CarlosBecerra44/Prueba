...
export function EmpresasTabla() {
  ...
  const handleDelete = async (index) => {
    try {
      ...
      Swal.fire('Error', 'Ocurrió un error al intentar eliminar la empresa', 'error');
    }
  };
  ...
  const handleSubmitUpdate = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        Swal.fire('Error', 'Error al actualizar los datos de la empresa', 'error');
      }
    } catch (err) {
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="flex items-center mb-4 text-sm text-muted-foreground">
        ...
        <ChevronRight className="mx-2 h-4 w-4" />
        <a href="/usuario/empresas" className="font-bold hover:underline text-primary">Administrador de empresas</a>
      </div>
      ...
      <div className="flex justify-between mb-4">
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button><EmpresasIcon className="mr-2 h-4 w-4" /> Añadir empresa</Button>
          </DialogTrigger>
          
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Nueva Empresa</DialogTitle>
              <DialogDescription>Ingresa los detalles de la empresa.</DialogDescription>
            </DialogHeader>
            ...
            {showIdentificacionForm && (
              <>
            <DialogHeader>
              <DialogTitle>Datos de Identificación del Contribuyente</DialogTitle>
            </DialogHeader>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="rfc" className="text-right">RFC</Label>
                <Input id="rfc" name="rfc" className="col-span-3" required value={formulario.rfc} onChange={(e) => handleInputChange(e.target.value, e.target.name)}/>
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="razon" className="text-right">Razón social</Label>
                <Input id="razon" name="razon" className="col-span-3" required value={formulario.razon} onChange={(e) => handleInputChange(e.target.value, e.target.name)}/>
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="regimen" className="text-right">Régimen capital</Label>
                <Input id="regimen" name="regimen" className="col-span-3" required value={formulario.regimen} onChange={(e) => handleInputChange(e.target.value, e.target.name)} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="nombre" className="text-right">Nombre comercial</Label>
                <Input id="nombre" name="nombre" className="col-span-3" required value={formulario.nombre} onChange={(e) => handleInputChange(e.target.value, e.target.name)}/>
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="fechaInicio" className="text-right">Fecha inicio de operaciones</Label>
                <Input id="fechaInicio" name="fechaInicio" type="date" className="col-span-3" required value={formulario.fechaInicio} onChange={(e) => handleInputChange(e.target.value, e.target.name)} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="estatus" className="text-right">Estatus en el padrón</Label>
                <Select
                  name="estatus"
                  value={formulario.estatus}
                  onValueChange={(value) => handleInputChange(value, "estatus")} 
                >
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="fechaCambio" className="text-right">Fecha de último cambio de estado</Label>
                <Input id="fechaCambio" name="fechaCambio" type="date" className="col-span-3" required value={formulario.fechaCambio} onChange={(e) => handleInputChange(e.target.value, e.target.name)} />
              </div>
              </>
)}
...
<div className="grid grid-cols-4 items-center gap-4">
  ...
  <>
    ...
    <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="codigo" className="text-right">Código postal</Label>
                <Input id="codigo" name="codigo" type="number" className="col-span-3" required value={formulario.codigo} onChange={(e) => handleInputChange(e.target.value, e.target.name)}/>
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="tipoVialidad" className="text-right">Tipo de vialidad</Label>
                <Input id="tipoVialidad" name="tipoVialidad" className="col-span-3" required value={formulario.tipoVialidad} onChange={(e) => handleInputChange(e.target.value, e.target.name)}/>
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="nombreVialidad" className="text-right">Nombre de vialidad</Label>
                <Input id="nombreVialidad" name="nombreVialidad" className="col-span-3" value={formulario.nombreVialidad} onChange={(e) => handleInputChange(e.target.value, e.target.name)} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="numeroExterior" className="text-right">Número exterior</Label>
                <Input id="numeroExterior" name="numeroExterior" className="col-span-3" value={formulario.numeroExterior} onChange={(e) => handleInputChange(e.target.value, e.target.name)} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="numeroInterior" className="text-right">Número interior</Label>
                <Input id="numeroInterior" name="numeroInterior" className="col-span-3" value={formulario.numeroInterior} onChange={(e) => handleInputChange(e.target.value, e.target.name)} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="nombreColonia" className="text-right">Nombre de la colonia</Label>
                <Input id="nombreColonia" name="nombreColonia" className="col-span-3" value={formulario.nombreColonia} onChange={(e) => handleInputChange(e.target.value, e.target.name)} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="nombreLocalidad" className="text-right">Nombre de la localidad</Label>
                <Input id="nombreLocalidad" name="nombreLocalidad" className="col-span-3" value={formulario.nombreLocalidad} onChange={(e) => handleInputChange(e.target.value, e.target.name)} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="nombreMunicipio" className="text-right">Nombre del municipio</Label>
                <Input id="nombreMunicipio" name="nombreMunicipio" className="col-span-3" value={formulario.nombreMunicipio} onChange={(e) => handleInputChange(e.target.value, e.target.name)} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="nombreEntidad" className="text-right">Nombre de la entidad federativa</Label>
                <Input id="nombreEntidad" name="nombreEntidad" className="col-span-3" value={formulario.nombreEntidad} onChange={(e) => handleInputChange(e.target.value, e.target.name)} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="entreCalle" className="text-right">Entre calle</Label>
                <Input id="entreCalle" name="entreCalle" className="col-span-3" value={formulario.entreCalle} onChange={(e) => handleInputChange(e.target.value, e.target.name)} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="yCalle" className="text-right">Y calle</Label>
                <Input id="yCalle" name="yCalle" className="col-span-3" value={formulario.yCalle} onChange={(e) => handleInputChange(e.target.value, e.target.name)} />
              </div>
  </>
)}
        ...
        <TableBody>
          {currentUsers.length >0 ?( currentUsers.map((user,index) => (
            ...
            <TableRow key={index}>
              ...
              <TableCell>
                {user.formulario.fechaInicio
                  ? new Date(new Date(user.formulario.fechaInicio).getTime() + new Date().getTimezoneOffset() * 60000).toLocaleDateString('es-ES', {
                      day: '2-digit',
                      month: '2-digit',
                      year: 'numeric',
                    })
              ...
              <TableCell>
                {user.formulario.fechaCambio
                  ? new Date(new Date(user.formulario.fechaCambio).getTime() + new Date().getTimezoneOffset() * 60000).toLocaleDateString('es-ES', {
                      day: '2-digit',
                      month: '2-digit',
                      year: 'numeric',
                    })
              ...
              <TableCell>{user.formulario.nombreVialidad || "Sin datos"}</TableCell>
              <TableCell>{user.formulario.numeroExterior || "Sin datos"}</TableCell>
              <TableCell>{user.formulario.numeroInterior || "Sin datos"}</TableCell>
              <TableCell>
            ...
            <DialogHeader>
              ...
              <DialogDescription>Actualiza los detalles necesarios de la empresa.</DialogDescription>
            </DialogHeader>
            ...
            <DialogHeader>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="rfc" className="text-right">RFC</Label>
                <Input id="rfc" name="rfc" className="col-span-3" value={selectedUser?.formulario?.rfc || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, rfc: e.target.value }, })}/>
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="razon" className="text-right">Razón social</Label>
                <Input id="razon" name="razon" className="col-span-3" value={selectedUser?.formulario?.razon || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, razon: e.target.value }, })}/>
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="regimen" className="text-right">Régimen capital</Label>
                <Input id="regimen" name="regimen" className="col-span-3" value={selectedUser?.formulario?.regimen || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, regimen: e.target.value }, })} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="nombre" className="text-right">Nombre comercial</Label>
                <Input id="nombre" name="nombre" className="col-span-3" value={selectedUser?.formulario?.nombre || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, nombre: e.target.value }, })}/>
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="fechaInicio" className="text-right">Fecha inicio de operaciones</Label>
                <Input id="fechaInicio" name="fechaInicio" type="date" className="col-span-3" value={selectedUser?.formulario?.fechaInicio || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, fechaInicio: e.target.value }, })} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="estatus" className="text-right">Estatus en el padrón</Label>
                <Select
                  name="estatus"
                  value={selectedUser?.formulario?.estatus || ''}
                  onValueChange={(value) => {
                    setSelectedUser((prev) => ({
                      ...prev,
                      formulario: {
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="fechaCambio" className="text-right">Fecha de último cambio de estado</Label>
                <Input id="fechaCambio" name="fechaCambio" type="date" className="col-span-3" value={selectedUser?.formulario?.fechaCambio || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, fechaCambio: e.target.value }, })} />
              </div>
              </>
)}
...
<div className="grid grid-cols-4 items-center gap-4">
  ...
  <>
    ...
    <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="codigo" className="text-right">Código postal</Label>
                <Input id="codigo" name="codigo" type="number" className="col-span-3" value={selectedUser?.formulario?.codigo || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, codigo: e.target.value }, })}/>
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="tipoVialidad" className="text-right">Tipo de vialidad</Label>
                <Input id="tipoVialidad" name="tipoVialidad" className="col-span-3" value={selectedUser?.formulario?.tipoVialidad || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, tipoVialidad: e.target.value }, })}/>
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="nombreVialidad" className="text-right">Nombre de vialidad</Label>
                <Input id="nombreVialidad" name="nombreVialidad" className="col-span-3" value={selectedUser?.formulario?.nombreVialidad || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, nombreVialidad: e.target.value }, })} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="numeroExterior" className="text-right">Número exterior</Label>
                <Input id="numeroExterior" name="numeroExterior" className="col-span-3" value={selectedUser?.formulario?.numeroExterior || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, numeroExterior: e.target.value }, })} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="numeroInterior" className="text-right">Número interior</Label>
                <Input id="numeroInterior" name="numeroInterior" className="col-span-3" value={selectedUser?.formulario?.numeroInterior || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, numeroInterior: e.target.value }, })} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="nombreColonia" className="text-right">Nombre de la colonia</Label>
                <Input id="nombreColonia" name="nombreColonia" className="col-span-3" value={selectedUser?.formulario?.nombreColonia || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, nombreColonia: e.target.value }, })} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="nombreLocalidad" className="text-right">Nombre de la localidad</Label>
                <Input id="nombreLocalidad" name="nombreLocalidad" className="col-span-3" value={selectedUser?.formulario?.nombreLocalidad || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, nombreLocalidad: e.target.value }, })} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="nombreMunicipio" className="text-right">Nombre del municipio</Label>
                <Input id="nombreMunicipio" name="nombreMunicipio" className="col-span-3" value={selectedUser?.formulario?.nombreMunicipio || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, nombreMunicipio: e.target.value }, })} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="nombreEntidad" className="text-right">Nombre de la entidad federativa</Label>
                <Input id="nombreEntidad" name="nombreEntidad" className="col-span-3" value={selectedUser?.formulario?.nombreEntidad || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, nombreEntidad: e.target.value }, })} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="entreCalle" className="text-right">Entre calle</Label>
                <Input id="entreCalle" name="entreCalle" className="col-span-3" value={selectedUser?.formulario?.entreCalle || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, entreCalle: e.target.value }, })} />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="yCalle" className="text-right">Y calle</Label>
                <Input id="yCalle" name="yCalle" className="col-span-3" value={selectedUser?.formulario?.yCalle || ''} onChange={(e) => setSelectedUser({ ...selectedUser, formulario: { ...selectedUser.formulario, yCalle: e.target.value }, })} />
              </div>
  </>
)}
