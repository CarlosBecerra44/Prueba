...
export async function middleware(req) {
  ...
  const roleRoutes = {
    ...
    isAdminMkt: ["/inicio", "/perfil", "/gente_y_cultura/faltasUsuario", "/marketing/estrategias", "/marketing/etiquetas/tabla_general", "/marketing/Editar", "/marketing/etiquetas", "/permisos"],
    isAdminGC: ["/inicio", "/perfil", "/gente_y_cultura/faltas", "/gente_y_cultura/faltasUsuario", "/usuario", "/usuario/empresas", "/gente_y_cultura/vacantes", "/permisos"],
    isStandardMkt: ["/inicio", "/perfil", "/gente_y_cultura/faltasUsuario", "/marketing/etiquetas/tabla_general", "/marketing/Editar", "/marketing/etiquetas", "/permisos"],
    isStandard: ["/inicio", "/perfil", "/gente_y_cultura/faltasUsuario", "/permisos"],
  };
